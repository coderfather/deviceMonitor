package com.deviceMonitor.util.message.util;
	...
	public void loadConfigProps() {
		...
		try {
			is = getClass().getResourceAsStream(
					"/WEB-INF/classes/resources/messageConfig.properties");
			if (is == null) {
				is = getClass().getResourceAsStream("/resources/messageConfig.properties");
			}
